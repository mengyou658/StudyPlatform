...
define([], function() {
    ...
    var CoursesCtrl = function($scope, $http, $state, $stateParams, modalService, playRoutes) {
        $scope.courses = [];

        playRoutes.controllers.CoursesController.list().get().success(function(data) {
            $scope.courses = data;
        });
    ...
    CoursesCtrl.$inject = [ '$scope', '$http', '$state', '$stateParams', 'modalService', 'playRoutes' ];
